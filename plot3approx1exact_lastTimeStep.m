...
function [] = plot3approx1exact_lastTimeStep(road1,road2,road3,roadE,tt,T)
    ...
    plot(s1,road1.xV{1},road1.rho{1}(:,end),road2.xV{1},road2.rho{1}(:,end),road3.xV{1},road3.rho{1}(:,end),roadE.xV{1},roadE.rho{1}(:,end))
    axis(s1,[-1 0 0 1])
    xlabel(s1,'x','Interpreter','latex')
    ylabel(s1,'density $\rho_1$','Interpreter','latex')
    
    plot(s2,road1.xV{2},road1.rho{2}(:,end),road2.xV{2},road2.rho{2}(:,end),road3.xV{2},road3.rho{2}(:,end),roadE.xV{2},roadE.rho{2}(:,end))
    axis(s2,[0 1 0 1])
    xlabel(s2,'x','Interpreter','latex')
    ylabel(s2,'density $\rho_2$','Interpreter','latex')
    
    plot(s3,tt,road1.r{1},tt,road2.r{1},tt,road3.r{1},tt,roadE.r{1},'.','MarkerSize',3)
    box(s3,'on')
    axis(s3,[0,T,0,road1.rMax{2}]);
    xlabel(s3,'t','Interpreter','latex')
    ylabel(s3,'buffer $r_1$','Interpreter','latex')
    
    plot(s4,tt,road1.r{2},tt,road2.r{2},tt,road3.r{2},tt,roadE.r{2},'.','MarkerSize',3)
    box(s4,'on')
